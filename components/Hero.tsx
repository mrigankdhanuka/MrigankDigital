...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center pt-24 pb-12 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center z-10">
        ...
        >
          ...
          <div className="h-8 md:h-10 mb-6 md:mb-8">
            <span className="text-lg sm:text-2xl md:text-3xl font-mono text-gray-300">
              I am a <span className="text-purple-400 font-bold">{text}</span>
              <span className="animate-pulse">|</span>
            </span>
          </div>

          <p className="text-gray-400 text-sm sm:text-lg md:text-xl max-w-lg mx-auto lg:mx-0 mb-8 md:mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start w-full sm:w-auto">
            <motion.button
              ...
              className="w-full sm:w-auto px-6 py-3.5 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 transition-all flex items-center justify-center gap-2 text-base"
            >
            ...
            <motion.button
              ...
              className="w-full sm:w-auto px-6 py-3.5 rounded-full border border-gray-600 bg-white/5 backdrop-blur-sm text-white font-semibold hover:bg-white/10 transition-all text-base"
            >
              Contact Me
            </motion.button>
          </div>
        ...
        <motion.div 
          ...
          className="h-[250px] sm:h-[400px] md:h-[500px] w-full flex items-center justify-center relative order-1 lg:order-2"
        >
